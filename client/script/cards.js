...
async function main() {
    ...
    card_2.innerHTML = `<img src=${lugares[index_card2].url} alt=${lugares[index_card1].cidade}></img>
                        <h3 class="subtitle">${lugares[index_card2].cidade}</h2>
                        <p>${lugares[index_card2].estado}</p>`
    card_1.innerHTML = `<img src=${lugares[index_card1].url} alt=${lugares[index_card1].cidade}></img>
                        <h3 class="subtitle">${lugares[index_card1].cidade}</h2>
                        <p>${lugares[index_card1].estado}</p>`
    card_3.innerHTML = `<img src=${lugares[index_card3].url} alt=${lugares[index_card1].cidade}></img>
